// ============================================================
//
//   EVO64 SUPER QUATTRO - A-D TWICE 4SID
//   ======================================
//
//   A native 4-SID music player for the EVO64 Super Quattro.
//
//   This program plays "A-D Twice" by Rayden (Patrick Zeh),
...
//     Tune 2: $1D00 (init) / $1D03 (play)  ->  SID @ $D420
//     Tune 3: $2A00 (init) / $2A03 (play)  ->  SID @ $D440
//     Tune 4: $3A00 (init) / $3A03 (play)  ->  SID @ $D460
//
...
.const TUNE2_INIT    = $1D00
.const TUNE2_PLAY    = $1D03
.const TUNE3_INIT    = $2A00
.const TUNE3_PLAY    = $2A03
.const TUNE4_INIT    = $3A00
.const TUNE4_PLAY    = $3A03
...
//  The full binary including the wrapper at $0F00-$0FFF
//  and all 4 sub-tunes ($1000-$493F).
//  Our harness bypasses the wrapper and calls sub-tunes directly.
// ============================================================

            * = $0F00 "A-D Twice 4SID"
            .import binary "../build/rayden_twice.bin"
...
.print ""
.print "============================================"
.print "  EVO64 Super Quattro - A-D Twice 4SID"
.print "============================================"
.print ""
.print "  Tune: A-D Twice 4SID by Rayden"
.print "  Format: RSID v4E (native 4-SID, 4 sub-tunes)"
.print "  Sub-tune 1: $1000/$1003 -> SID $D400"
.print "  Sub-tune 2: $1D00/$1D03 -> SID $D420"
.print "  Sub-tune 3: $2A00/$2A03 -> SID $D440"
.print "  Sub-tune 4: $3A00/$3A03 -> SID $D460"
.print ""
