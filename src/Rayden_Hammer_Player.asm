// ============================================================
//
//   EVO64 SUPER QUATTRO - A-D HAMMER 4SID
//   =======================================
//
//   A native 4-SID music player for the EVO64 Super Quattro.
//
//   This program plays "A-D Hammer" by Rayden (Patrick Zeh),
//   composed natively for 4 SID chips using the DMC music
//   editor with 4-SID export (RSID v4E format).
//
//   The binary contains 4 independent SID-WIZARD player
//   instances, each pre-configured for its own SID chip:
//
//     Tune 1: $1000 (init) / $1003 (play)  ->  SID @ $D400
//     Tune 2: $1F00 (init) / $1F03 (play)  ->  SID @ $D420
//     Tune 3: $2C00 (init) / $2C03 (play)  ->  SID @ $D440
//     Tune 4: $3D00 (init) / $3D03 (play)  ->  SID @ $D460
//
//   The original RSID wrapper at $0FA0-$0FFF is included in
//   the binary but is bypassed -- our harness calls each
//   sub-tune's init/play directly via raster IRQ.
//
...
// Sub-tune entry points (each is a standard init/play pair)
.const TUNE1_INIT    = $1000
.const TUNE1_PLAY    = $1003
.const TUNE2_INIT    = $1F00
.const TUNE2_PLAY    = $1F03
.const TUNE3_INIT    = $2C00
.const TUNE3_PLAY    = $2C03
.const TUNE4_INIT    = $3D00
.const TUNE4_PLAY    = $3D03
...
//  The full binary including the wrapper at $0FA0-$0FFF
//  and all 4 sub-tunes ($1000-$4C82).
//  Our harness bypasses the wrapper and calls sub-tunes directly.
// ============================================================

            * = $0FA0 "A-D Hammer 4SID"
            .import binary "../build/rayden_hammer.bin"
...
.print ""
.print "============================================"
.print "  EVO64 Super Quattro - A-D Hammer 4SID"
.print "============================================"
.print ""
.print "  Tune: A-D Hammer 4SID by Rayden"
.print "  Format: RSID v4E (native 4-SID, 4 sub-tunes)"
.print "  Sub-tune 1: $1000/$1003 -> SID $D400"
.print "  Sub-tune 2: $1F00/$1F03 -> SID $D420"
.print "  Sub-tune 3: $2C00/$2C03 -> SID $D440"
.print "  Sub-tune 4: $3D00/$3D03 -> SID $D460"
.print ""
