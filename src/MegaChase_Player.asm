// ============================================================
//
//   EVO64 SUPER QUATTRO - MEGA CHASE THEME
//   ========================================
//
//   A native 4-SID music player for the EVO64 Super Quattro.
//
//   This program plays the "Mega Chase Theme" by SHAD0WFAX,
...
title_line8:
            ...
            .byte $13,$08,$01,$04,$30,$17,$06,$01,$18               // SHAD0WFAX
            .byte $00
...
// ============================================================
            ...
            * = $1000 "Mega Chase Theme - 4-SID"
            .import binary "../build/megachase.bin"
...
.print ""
.print "============================================"
.print "  EVO64 Super Quattro - Mega Chase Theme"
.print "============================================"
.print ""
.print "  Tune: Mega Chase Theme by SHAD0WFAX"
